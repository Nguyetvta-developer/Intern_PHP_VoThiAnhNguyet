...
class DeviceController extends Controller
{
    ...
    public function index(){
        ...
        return view('device.device',compact('data'));
    }
    public function create(){
        $data = category::all();
        return view('device.add_device',compact('data'));
    }
    ...
    public function detail($id){
        ...
        return view('device.device_detail',compact('data'));
    }
    public function edit($id){
        $category = category::all();
        $device = DB::table('device')->where('id', $id)->first();
        return view('device.edit_device',compact('category','device'));
    }
